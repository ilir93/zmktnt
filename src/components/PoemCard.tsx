...
export function PoemCard({ poem, index, copiedIndex, onShare, onCopy }: PoemCardProps) {
  ...
  return (
    <article className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow relative">
      <span className="absolute -top-4 -left-4 w-8 h-8 bg-rose-600 text-white rounded-full flex items-center justify-center font-bold shadow-md">
        {poemNumber}
      </span>
